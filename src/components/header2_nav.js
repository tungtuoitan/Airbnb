...
class Header2Nav extends React.Component {
  render() {
    ...
    return (
      <div className=" NAVIGATION  flex justify-between 7:px-10 14:px-20  absolute top-0 left-0 w-full h-full overflow-hidden">
        <div
        ...
        <div
          className={`RIGHT   hidden 7:flex    z-10 h-full mt-c7    justify-center items-center  ${
        ...
        >
          <div
            className={`ARROW_RIGHT    hidden 7:flex  w-16 h-20 ml-8  gradient-white-toleft           justify-end items-center   top-0   color222 ${
              arrowRightDisplay === true ? "7:opacity-100" : "7:opacity-0"
            }
              ${
                arrowRightDisplay === true
                  ? "pointer-events-auto"
