...
export default function ConfirmRequestPopUp() {
  ...
  return (
    <div
      ...
      ${isConfirmRequestOn && widthScreen <745 ?'bottom-0  trans-pop'
      :!isConfirmRequestOn && widthScreen<745? 'f1 ':''}
      ${isConfirmRequestOn && widthScreen>=745 ?'confirm-popup trans-pop'
      :!isConfirmRequestOn && widthScreen>=745 ?'f2':''}`}
    >
      <div
