...
class Footer extends React.Component {
  render() {
    return (
      <div className="FOOTERR bg-grayf7 w-full px-6 py-12 7:px-10 14:px-20   ">
        <div className="">
          <LocationGrid />

          <div className="GRIDD_2 grid grid-cols-1 9:grid-cols-3 gap-x-c10">
          ...
          <div className="FINAL text-left 9:text-center font-size14  font-semibold color222 py-c24">
