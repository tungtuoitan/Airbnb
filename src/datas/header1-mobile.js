export default function Header1Mobile ()  {
  return (
      <div className="search_bar   w-calc-headermobile      flex justify-between items-center  w-calc-48 h-14 mt-c14 rounded-full border-gray-200 border-1  shadow-searchbox-smartf text-sm font-semibold color222">
        <div className="kkk flex items-center">
