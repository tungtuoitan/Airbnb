...
function HomePage() {
  return (
    <div>
      <div className="TWO_HEADERS        overflow-hidden shadow-header-smartf   ">
        <div className="HEADER_1  px-10 border-b-1 14:px-20 ">
          <div className="header_cho_destop w-      h-20 items-center  hidden 7:flex  justify-between ">
            ...
            >
              ...
              <path
                ...
                fill="currentcolor"
                className="hidden 11:block"
              ></path>
            </svg>

            <div className="search-box-laptop      inline-flex justify-center items-center h-12 rounded-full border-gray-200 border-1 w-auto shadow-searchbox text-sm font-semibold color222">
              <div className="  ml-2 ">
            ...
            <div className="flex items-center gap-4 ">
              ...
              <div className="flex pl-c12 gap-c12 items-center border-1 border1-gray rounded-full w-c77 h-c42">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 32 32"
                  aria-hidden="true"
        ...
        <div className="header_cho_mobile    flex 7:hidden w-min-285   justify-center">
        ...
        <div className=" HEADER_2     7:pr-10  relative pl-6 7:pl-10 14:px-20  ">
          <div className="XYZ   overflow-hidden  relative">
            <div className="ARROW_LEFT   hidden hidden 7:flex top-0 absolute z-10     h-20  absolute w-10  gradient-white         items-center  color222 ">
              <div className="border-1 border-gray-400 w-7 h-7 pt-1px pr-1px rounded-full bg-white">
                <i class="fa-solid fa-angle-left fa-sm"></i>
              </div>
            </div>

            <div className=" RIGHT   hidden 7:flex gradient-white-toleft  z-20 gap-4 justify-center items-center absolute right-0 top-0  ">
              <div className=" ARROW_RIGHT    hidden 7:flex  w-10 h-20 ml-8           justify-center items-center   top-0   color222  ">
                <div className="         bg-white color222 border-1 pt-1px border-gray-400 w-7 h-7 rounded-full bg-white">
      ...
      <div className="   px-6 pb-10 7:px-10 14:px-20    h-full mt-6       ">
        <div className="GRID-CONTAINER      grid-homepage      h-auto          ">
          ...
          {/* <div className="color222 border-t-1 border-gray-300 pt-12 pb-8">
              <p className="font-bold font-size18 mb-4">
                Continue exploring rooms
              </p>
              <button className="border-1 px-c24 py-c12 border-black rounded-md font-semibold text-base">
                Show more
              </button>
            </div> */}
        </div>
